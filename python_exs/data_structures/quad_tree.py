...
class Rectangle:
	...
	def is_intersect(self, rect):
		return not (rect._bottom_left.x - rect._width > self._bottom_left.x + self._width or
		            rect._bottom_left.x + self._width < self._bottom_left.x - self._width or
		            rect._bottom_left.y - rect._height > self._bottom_left.y + self._height or
		            rect._bottom_left.y + rect._height < self._bottom_left.y - self._height) 
...
def quad_tree_plotter(ax, qtree, color='k'):
	...
	def draw_members(axis, point_list):
		for point in point_list:
			axis.scatter(point.x, point.y, marker='*')
		return axis
	ax = draw_rectangle(ax, qtree._rect)
	ax = draw_members(ax, qtree._members)
	# print("_members")
...
def test():
	...
	print(qtree.query(test_rectangle))
